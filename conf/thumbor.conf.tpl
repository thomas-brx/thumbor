...
IMGIX_COMPAT_CHECK_LEADING_SLASH = {{ IMGIX_COMPAT_CHECK_LEADING_SLASH | default(False) }}
IMGIX_HANDLER_PREFIX = '{{ IMGIX_HANDLER_PREFIX | default('') }}'

FALLBACK_LOADER_BASE_LOADER = '{{ FALLBACK_LOADER_BASE_LOADER | default('thumbor.loaders.http_loader') }}'
